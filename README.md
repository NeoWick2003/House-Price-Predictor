...
Created a ML project ( R-sqaured ~ 0.71) which can predict house prices across various locations in India. Also, created an interactive website forputting in various details and criteria. Currently, working on reducing the response time of the website (takes time due to the use of huge data set). 
